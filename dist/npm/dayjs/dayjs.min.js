!function (t, n) {
  ...
  var t = "millisecond",
    ...
    var r = String(t);return !r || r.length >= n ? t : "" + Array(n + 1 - r.length).join(e) + t;
      ...
      return { M: u, y: o, w: s, d: i, h: r, m: e, s: n, ms: t, Q: a }[h] || String(h || "").toLowerCase().replace(/s$/, "");
    }, u: function (t) {
      return undefined === t;
    } },
    ...
    var r;if (!t) return null;if ("string" == typeof t) m[t] && (r = t), n && (m[t] = n, r = t);else {
      ...
      g = function (t, n, e) {
    if (y(t)) return t.clone();var r = n ? "string" == typeof n ? { format: n, pl: e } : n : {};return r.date = t, new S(r);
  },
    ...
    function c(t) {
      ...
      var h = this,
        ...
        return D.w(h.toDate()[t].apply(h.toDate(), (f ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(n)), h);
          ...
          var g = this.$locale().weekStart || 0,
              S = (l < g ? l + 7 : l) - g;return d(f ? y - S : y + (6 - S), m);case i:case "date":
      ...
      var h,
          ...
          $ = f === i ? this.$D + (a - this.$W) : a;return this.$d[d] && this.$d[d]($), this.init(), this;
    }, d.set = function (t, n) {
      ...
      var h,
          ...
          d = function (n, e) {
        var r = f.clone().set("date", 1).set(n, e + t);return r.set("date", Math.min(f.$D, r.daysInMonth()));
      },
          $ = function (n) {
        var e = new Date(f.$d);return e.setDate(e.getDate() + n * t), D.w(e, f);
      };if (c === u) return d(u, this.$M);if (c === o) return d(o, this.$y);if (c === i) return $(1);if (c === s) return $(7);var l = (h = {}, h[e] = 6e4, h[r] = 36e5, h[n] = 1e3, h)[c] || 1,
          m = this.valueOf() + t * l;return D.w(m, this);
      ...
      var n = this;if (!this.isValid()) return "Invalid Date";var e = t || "YYYY-MM-DDTHH:mm:ssZ",
        ...
        return D.s(n.$H % 12 || 12, t, "0");
          ...
          h = { YY: String(this.$y).slice(-2), YYYY: String(this.$y), M: String(this.$M + 1), MM: D.s(this.$M + 1, 2, "0"), MMM: a(i.monthsShort, this.$M, u, 3), MMMM: u[this.$M], D: String(this.$D), DD: D.s(this.$D, 2, "0"), d: String(this.$W), dd: a(i.weekdaysMin, this.$W, s, 2), ddd: a(i.weekdaysShort, this.$W, s, 3), dddd: s[this.$W], H: String(this.$H), HH: D.s(this.$H, 2, "0"), h: o(1), hh: o(2), a: this.$H < 12 ? "am" : "pm", A: this.$H < 12 ? "AM" : "PM", m: String(this.$m), mm: D.s(this.$m, 2, "0"), s: String(this.$s), ss: D.s(this.$s, 2, "0"), SSS: D.s(this.$ms, 3, "0"), Z: r };return e.replace(f, function (t) {
      ...
      var c,
          ...
          m = this - $,
          y = D.m(this, $);return y = (c = {}, c[o] = y / 12, c[u] = y, c[a] = y / 3, c[s] = (m - l) / 6048e5, c[i] = (m - l) / 864e5, c[r] = m / 36e5, c[e] = m / 6e4, c[n] = m / 1e3, c)[d] || m, f ? y : D.a(y);
